...
export default function TrustedSection() {
  ...
  return (
    <Container
      ...
      my={{ base: 16, md: 24 }}
    >
      <VStack spacing={2} align="center" flex={1} mb={{ base: 8, md: 0 }}>
