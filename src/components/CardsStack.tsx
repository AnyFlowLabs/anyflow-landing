...
const CardStack: FC = () => {
  ...
  return (
    <VStack ref={containerRef} w="full" pos="relative" gap={4} p={0} m={0}>
        ...
        <VStack align="flex-start" w="full" spacing={8}>
          <VStack align="flex-start" spacing={6} maxW="800px">
            ...
            <Heading
              ...
              data-aos="fade-up"
            >
              Deploy Smart Contracts in Minutes, Not Hours
            </Heading>
            <Text
              color="gray.300"
          ...
          <SimpleGrid columns={{ base: 1, md: 2 }} spacing={6} w="full">
            {[
              ...
              >
                <Text color="brand.300" fontWeight="bold" fontSize="lg" mb={3}>
                  {step.title}
                </Text>
      ...
      <Box
        bgGradient="linear(to-br, brand.500, gray.800, gray.800, gray.800, gray.900)"
        border="solid 1px"
        p={{ base: 8, md: 16 }}
        borderColor="gray.500"
        boxShadow="2xl"
