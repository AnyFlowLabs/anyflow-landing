  ...
  translation: {
    ...
    home: {
      ...
      deploymentFuture: {
        ...
        description: "Experience the magic of one-click deployments with Anyflow - where complexity meets simplicity",
      },
      optimization: {
        title: "Optimize your workflow for faster development",
        subtitle: "Concentrate on crafting exceptional blockchain solutions while we streamline the technical details",
      },
      streamline: {
      ...
      cards: {
        oldWay: {
          ...
          description: "Previously, you had to go through a time-intensive and complex process",
          steps: {
            step1: {
              title: "Cryptocurrency Acquisition",
              description: "Acquire native tokens through complex exchanges and multiple wallets."
            },
            step2: {
              title: "Account Management",
              description: "Manage various accounts, transfer funds, and configure multiple wallets."
            },
            step3: {
              title: "Technical Setup",
              description: "Configure RPC providers, manage API keys, and test connections for hours."
            },
            step4: {
              title: "Security Concerns",
              description: "Secure private keys and ensure their accessibility for deployments."
            },
            step5: {
              title: "Repeat for Each Network",
              description: "Duplicate efforts across every network for deployment."
            }
          }
        },
        futureWay: {
          ...
          features: {
            oneClick: {
              ...
              description: "Deploy instantly with one command—no wallet setup or token buying needed."
            },
            automatedSetup: {
              title: "Automated setup",
              description: "Automatically configures everything from RPC endpoints to network selection."
            },
            security: {
              title: "Built-in Security",
              description: "Ensures enterprise-grade security automatically, enforcing best practices.",
              badges: {
                secure: "Secure",
                audited: "Audited",
                protected: "Protected"
            ...
            costEfficiency: {
              ...
              description: "Only pay for deployments with clear pricing and no hidden fees or mandatory tokens.",
              badges: {
        ...
        anyflow: {
          ...
          description: "Concentrate on crafting exceptional blockchain solutions while we streamline the technical details"
        }
      },
      deployment: {
        title: "Fastest multichain deployment",
        description: "Instantly deploy smart contracts across multiple blockchains. Focus on innovation while our platform handles the complexities swiftly—deployments are completed in seconds.",
        terminal: {
        ...
        features: {
          ultraFast: {
            ...
            description: "Deploy contracts instantly with our streamlined pipeline, designed for speed."
          }
        }
      },
      faq: {
        ...
        subtitle: "Find answers to the most common questions about Anyflow's deployment platform",
        questions: {
          what: {
            question: "What is Anyflow?",
            answer: "Anyflow is a smart contract deployment platform that simplifies deploying contracts across multiple blockchains. It removes the need to manage wallets, buy tokens, or handle complex technical configurations."
          },
          how: {
            question: "How does one-click deployment work?",
            answer: "Our platform automates every step of the deployment process. Connect your project, choose your target network, and click deploy. We handle everything, including wallet management, gas fees, and network setup."
          },
          tokens: {
            question: "Do I need to buy tokens for deployment?",
            answer: "No! Anyflow eliminates token management. We handle all token requirements for you, so you can deploy contracts without purchasing or managing native tokens."
          },
          security: {
            question: "Is Anyflow secure?",
            answer: "Yes! Security is our highest priority. We use enterprise-grade measures, and automated audits, and enforce best practices. Your code and credentials are always encrypted and protected."
          },
          chains: {
            question: "Which blockchains are supported?",
            answer: "Anyflow supports all major EVM-compatible networks, such as Ethereum, Polygon, BSC, Avalanche, and more. We are continuously adding new networks based on community demand."
          }
        }
      },
      cards: {
      ...
      trusted: {
        ...
        description: "Secured a top 4 position in the 2024 Copa America hackathon, organized by Solana to highlight innovation."
      },
      features: {
        security: {
          title: "Robust security",
          description: "Automatic security checks and audits are standard, ensuring your deployments are always secure."
        },
        configurable: {
          title: "Fully configurable",
          description: "Adjust the deployment process to meet the specific needs of your projects effortlessly."
        }
      },
      cli: {
        title: "Unlock the potential of our CLI tool",
        description: "Streamline your development workflow with a tool built for efficiency and simplicity",
        features: {
          easy: "Easy to use",
      ...
      partners: {
        khiza: {
          description: "Anyflow is part of the Khiza ecosystem, a Brazilian startup studio dedicated to driving innovation in web3."
        },
        quicknode: {
          description: "Quicknode partners with Anyflow to enhance blockchain deployment capabilities and developer tools."
        },
        builder: {
          description: "Ranked in the top 3.5% of Backdrop Build V4, a program blending acceleration and hackathon."
        },
        xdc: {
          description: "Anyflow Received a grant from the XDC blockchain to expand integrations and advance product development."
        }
      }
    },
  },
